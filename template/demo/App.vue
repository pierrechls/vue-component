    ...
    <div id="app">
      ...
      <a :href="repoUrl" class="github-corner" aria-label="View source on Github">
          <svg width="80" height="80" viewBox="0 0 250 250"
               style="fill:#35495e; color:#fff; position: absolute; top: 0; border: 0; right: 0;" aria-hidden="true">
                ...
                <div class="container">
                    <div class="columns">
                      <div class="column is-7">
                        <div class="column is-9 is-offset-1" style="display: flex; align-items: center;">
                            ...
                            <div class="is-pulled-left" style="text-align: left">
                                ...
                                <div class="buttons">
                                  <iframe src="https://ghbtns.com/github-btn.html?user={{ gitRepoAuthor }}&amp;repo={{ gitRepoName }}&amp;type=star&amp;count=true&amp;size=medium" frameborder="0" scrolling="0" width="160px" height="30px"></iframe>
                                  <iframe src="https://ghbtns.com/github-btn.html?user={{ gitRepoAuthor }}&amp;repo={{ gitRepoName }}&amp;type=fork&amp;count=true&amp;size=medium" frameborder="0" scrolling="0" width="158px" height="30px"></iframe>
                                </div>
                      ...
                      <div class="column is-5">
                        <vue-component :event-bus="bus"></vue-component>
                      </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    import VueComponent from '../src/VueComponent.vue';
    import Vue from 'vue';

    const componentName = '{{ name }}';
    const componentDesc = '{{ description }}';
    const repoUrl = '{{ gitRepoUrl }}';
    const repoFullName = '{{ gitRepoAuthor }}/{{ gitRepoName }}';
